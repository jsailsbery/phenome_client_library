...
original_author="jsailsbery"
original_name="phenome_client_library"
original_urlname="phenome_client_library"
original_description="Awesome phenome_client_library created by jsailsbery" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/phenome_client_library "${name}"
...
then
    ...
    echo "then run 'phenome_client_library' or 'python -m phenome_client_library'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'phenome_client_library' or 'python -m phenome_client_library' or 'poetry run phenome_client_library'"
fi
